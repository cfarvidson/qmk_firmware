...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_CODING] = LAYOUT_5x6(
    ...
    [_NUMBERS] = LAYOUT_5x6(
     ...
     _______,_______,_______,_______,_______,_______,                         LSFT(KC_1), KC_P1  , KC_P2 , KC_P3 ,_______,_______,
                       _______,_______,                                                           _______,_______,
  ...
  [_WORDNAV] = LAYOUT_5x6(
     ...
     KC_TRNS,POWERNAV,KC_TRNS,RCS(KC_TAB),LCTL(KC_TAB) ,KC_TRNS,              _______,_______,_______,_______,_______,_______,
                      _______,_______,                                                        _______,_______,
                                          _______,_______,                        _______,_______,
                                          _______,_______,                        _______,_______,
                                          _______,_______,                        _______,_______
  ...
  [_POWERNAV] = LAYOUT_5x6(
     ...
     _______,_______,_______,_______,_______,_______,                         _______,LGUI(KC_LEFT),KC_TRNS,LGUI(KC_RGHT),_______,_______,
