...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ARROWS] = LAYOUT_5x6(
     _______,________,_______,_______,_______,_______,                         KC_CAPS     ,_______,_______,_______,_______,_______,
     _______,________,_______,_______,_______,_______,                         _______     ,KC_HOME, KC_UP ,KC_END ,_______,_______,
     _______,________,_______,_______,_______,_______,                         LSFT(KC_1)  ,KC_LEFT,KC_DOWN,KC_RGHT,_______,_______,
  ...
  [_WORDNAV] = LAYOUT_5x6(
     _______,________,_______,___________,___________,_________,                         _______,_____________,_______,_____________,_______,_______,
     _______,________,_______,___________,___________,_________,                         _______,_____________, KC_UP ,_____________,_______,_______,
     _______,________,_______,___________,___________,_________,                         _______,LALT(KC_LEFT),KC_DOWN,LALT(KC_RGHT),_______,_______,
     KC_TRNS,POWERNAV,KC_TRNS,RCS(KC_TAB),LCTL(KC_TAB) ,KC_TRNS,                         _______,_____________,_______,_____________,_______,_______,
  ...
  [_POWERNAV] = LAYOUT_5x6(
     _______,_______,_______,_______,_______,_______,                         _______,_____________,_______,_____________,_______,_______,
     _______,_______,_______,_______,_______,_______,                         _______,_____________,KC_TRNS,_____________,_______,_______,
     _______,_______,_______,_______,_______,_______,                         _______,LGUI(KC_LEFT),KC_TRNS,LGUI(KC_RGHT),_______,_______,
     KC_TRNS,_______,_______,_______,_______,_______,                         _______,_____________,_______,_____________,_______,_______,
                      _______,_______,                                                        _______,_______,
                                          _______,_______,                  _______,_______,
                                          _______,_______,                  _______,_______,
                                          _______,_______,                  _______,_______
  ...
  [_APPS] = LAYOUT_5x6(
     _______,_______,_______,____________,____________,_______,                         _______,_______,_______,_______,_______,_______,
     _______,_______,_______,____________,____________,_______,                         _______,_______,_______,_______,_______,_______,
     _______,_______,_______,____________,____________,_______,                         _______,_______,_______,_______,_______,_______,
