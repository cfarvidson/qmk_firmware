...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_POINTER] = LAYOUT(
    ...
    [_SYM] = LAYOUT(
       KC_PGUP, KC_HOME, KC_END, XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    SE_LABK, SE_AT  , SE_LPRN, SE_RPRN, SE_HASH, XXXXXXX,
       KC_PGDN, HC_LGUI, KC_LALT, KC_LCTL,KC_RSFT, XXXXXXX,    SE_RABK, SE_EQL , SE_LCBR, SE_RCBR, SE_DLR, XXXXXXX,
