/* Userspace keymap for Dactyl-Manuform 5x6 - mirrors other keyboards in this userspace */
...
enum dmf_layers { _BASE, _NAV, _MOUSE, _MEDIA, _NUM, _SYM, _FUN, _Q };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_5x6(
      ...
      KC_ESCAPE,   HC_A,    HC_S,    HC_D,    HC_F,    KC_G,                         KC_H,    HC_J,    HC_K,    HC_L, HC_ODIA, SE_ADIA,
        ...
        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                     ...
                                     LT(_SYM,KC_TAB),LT(_NUM,KC_BSPC),            LT(_MEDIA,KC_ENTER),LT(_NAV, KC_SPACE),
                                     LT(_FUN,KC_DEL), XXXXXXX,                     LT(_MOUSE, KC_ESCAPE), XXXXXXX,
                                     XXXXXXX, XXXXXXX,                             XXXXXXX, XXXXXXX
  ),
  ...
  [_MEDIA] = LAYOUT_5x6(
       ...
       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                     XXXXXXX, XXXXXXX,                                         XXXXXXX, XXXXXXX,
                                     KC_MUTE, KC_MPLY,                             KC_MSTP, XXXXXXX,
                                     XXXXXXX, XXXXXXX,                             XXXXXXX, XXXXXXX,
                                     XXXXXXX, XXXXXXX,                             XXXXXXX, XXXXXXX
  ),
  ...
  [_NUM] = LAYOUT_5x6(
       ...
       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                     XXXXXXX, XXXXXXX,                                         SE_MINS,    KC_0,
                                     XXXXXXX, XXXXXXX,                             SE_DOT, XXXXXXX,
                                     XXXXXXX, XXXXXXX,                             XXXXXXX, XXXXXXX,
                                     XXXXXXX, XXXXXXX,                             XXXXXXX, XXXXXXX
  ),

  [_SYM] = LAYOUT_5x6(
       KC_PGUP, KC_HOME, KC_END, XXXXXXX, XXXXXXX, XXXXXXX,                      SE_LABK, SE_AT  , SE_LPRN, SE_RPRN, SE_HASH, XXXXXXX,
       KC_PGDN, KC_LGUI, KC_LALT, KC_LCTL,KC_RSFT, XXXXXXX,                      SE_RABK, SE_EQL , SE_LCBR, SE_RCBR, SE_DLR , XXXXXXX,
  ...
  [_Q] = LAYOUT_5x6(
       ...
       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                     LGUI(KC_GRV), XXXXXXX,                                  XXXXXXX, KC_ESCAPE,
                                     XXXXXXX, XXXXXXX,                             XXXXXXX, XXXXXXX,
                                     XXXXXXX, XXXXXXX,                             XXXXXXX, XXXXXXX,
                                     XXXXXXX, XXXXXXX,                             XXXXXXX, XXXXXXX
  ),
